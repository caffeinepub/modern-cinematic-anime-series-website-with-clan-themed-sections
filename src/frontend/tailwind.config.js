    ...
    theme: {
        ...
        extend: {
            colors: {
                ...
                'clan-moon': 'oklch(var(--clan-moon))',
                'clan-sun': 'oklch(var(--clan-sun))',
                'clan-fire': 'oklch(var(--clan-fire))',
                'clan-water': 'oklch(var(--clan-water))',
                'clan-lightning': 'oklch(var(--clan-lightning))',
                'clan-earth': 'oklch(var(--clan-earth))',
                'clan-balance': 'oklch(var(--clan-balance))'
            },
            borderRadius: {
                lg: 'var(--radius)',
